...
#cros_results <- cv_CDpre(Xgenerate, Jk, R, CommPosition=Comm, component_structure=comStr, MaxIter=MAXITER, NRSTARTS=NRSTARTS)

cros_results <- cv_CDpre(Xgenerate, Jk, R, CommPosition=Comm, component_structure=comStr, MaxIter=MAXITER, NRSTARTS=NRSTARTS, LassoSequence = seq(from=0.0001, to=1.5, length.out = 10))
...
cros_results <- cv_CDpre(Xgenerate, Jk, R, CommPosition=Comm, component_structure=comStr, MaxIter=MAXITER, NRSTARTS=NRSTARTS, LassoSequence = seq(from=0.0001, to=1, length.out = 10))
