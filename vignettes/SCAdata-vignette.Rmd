...
`crossvali()` is a function for identifying possible range of Lasso tuning parameters for the sparse common component(s), given the distictive components are known. At this moment, little research is done on cross-validation procedures for sparse common and distinctive componets. 
